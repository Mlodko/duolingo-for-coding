...
const ForgotPassword: NextPage = () => {
  ...
  return (
    <div className="bg-darker-purple text-white flex min-h-screen flex-col items-center">
      <header className="flex h-[70px] w-full justify-center font-bold">
        <div className="flex max-w-5xl grow items-center justify-between px-5">
          ...
          <div className="hidden items-center gap-5 md:flex">
            <LanguageDropDown />
            <button
              className="rounded-2xl border-b-4 border-pink-ish bg-dark-purple px-4 py-2 transition hover:bg-pink-ish hover:border-dark-purple"
      ...
      <div className="flex w-full grow flex-col items-center gap-5 px-5 pt-5 sm:w-96 sm:pt-52">
        ...
        <p className="text-center">
          tell us the email, and you will get a message there with link to reset your password.
        </p>
        <div className="flex w-full flex-col gap-2">
          <input
            className="text-black w-full rounded-2xl border-2 border-dark-purple bg-white px-4 py-3"
            placeholder="your email"
          />
          <button className="w-full rounded-2xl border-b-4 border-pink-ish bg-dark-purple py-3 font-bold transition hover:bg-pink-ish hover:border-dark-purple">
