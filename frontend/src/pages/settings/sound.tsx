...
const Sound: NextPage = () => {
  ...
  const [localListeningExercises] =
    useState(listeningExercises);

  const soundOptions = [
    {
      title: "sound effects during lessons",
    ...
    <div className="min-h-screen bg-darker-purple text-white">
      ...
      <div className="mx-auto flex flex-col gap-5 px-4 py-20 sm:py-10 md:pl-28 lg:pl-72">
        <div className="mx-auto flex w-full max-w-xl items-center justify-between lg:max-w-4xl">
          <h1 className="text-lg font-bold text-gray-800 sm:text-2xl">sounds</h1>
          <button
        ...
        <div className="flex justify-center gap-12">
          ...
          <SettingsRightNav selectedTab="sounds" />
        </div>
      </div>
    </div>
  );
